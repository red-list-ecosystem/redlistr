...
We love collaboration! You are welcome to suggest general improvements to the package structure or to whatsoever. We appreciate any contribution and collaboration.
...
Browse the [documentation](https://red-list-ecosystem.github.io/redlistr/) to see if you can find a solution. Still stuck? Open an [issue on GitHub](https://github.com/red-list-ecosystem/redlistr/issues) on GitHub. We'll try to do our best to address it, as questions often lead to better documentation or the discovery of bugs.

If you want to ask a question in private get in contact by [anikobtoth\<at\>gmail.com](mailto:anikobtoth@gmail.com) or [jr.ferrer.paris<at>gmail.com](mailto:jr.ferrer.paris@gmail.com).
...
Take a look at the [documentation](https://red-list-ecosystem.github.io/redlistr/) and [issue on GitHub](https://github.com/red-list-ecosystem/redlistr/issues) list to see if it isn't included or suggested yet. If not, please open a new issue!
...
Report it as an [issue on GitHub](https://github.com/red-list-ecosystem/redlistr/issues) so we can fix it. A good bug report makes it easier for us to do so, so please include:
...
1. Fork [the repo](https://github.com/red-list-ecosystem/redlistr/) and clone it to your computer. To learn more about this process, see [this guide](https://guides.github.com/activities/forking/). Don't forget to pull all new changes before starting to work!
