...
There are some handy summary functions for the EOO object that is returned. We can also extract the area of the EOO polygon. 
...
This result can then be combined with additional
...
ecosystems that are contained in more than 100 grid cells, the default
...
Both the `getEOO()` and `getAOO()` functions work on polygons too. 
...
If these plots look unconvincing, you can increase the number
