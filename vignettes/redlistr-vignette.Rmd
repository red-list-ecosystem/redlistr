...
Most distribution maps of ecosystems and species will be provided in raster or vector (shapefile) format. We will use the excellent `raster`, `sp`, and `rgeos` packages to import data, to enable us to begin to use the functions in the `redlistr` package.
...
The result: at time 1 (1990) the ecosystem was `a.r1` km2 and at time 2 (2012) the ecosystem was `a.r2` km2.
