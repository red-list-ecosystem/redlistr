...
2015; [Bland et al. 2016](https://portals.iucn.org/library/sites/library/files/documents/2016-010.pdf)).
...
Start with getting the area of the dataset, noting there has been loss of the
ecosystem over the time. Note that area is calculated using the pixel count
method, where the number of pixels multiplied by the area of each pixel is used
to determine the area of the ecosystem, which is provided in square kilometres.
We can also check the resolution of the data (in metres).
...
The result: at time 1 (1990) the ecosystem was `r a.r1` km2 and at time 2 (2012) the ecosystem was `r a.r2` km2.
