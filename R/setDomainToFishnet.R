...
#'
#' \code{setDomainToFishnet} sets the extent of an input ecosystem raster
#' to the same size as another raster (in this case an AOO grid).All new
#' raster cells are set to to the specified value (probably NA). Its primary
#' use will be for simulation modelling.
#'
...
#' @return A raster object of x with the extent of y with new values specified by
#' value
