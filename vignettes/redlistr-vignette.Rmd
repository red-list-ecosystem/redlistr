...
For our example, due to the small overall size of the ecosystem, a one percent
rule might be too strict, though we might still want to exclude the very small
...
```
The results here shows that the minimum AOO does indeed change in response to 
...
`gridUncertainty`). We hope that with this tool, we can ensure a consistent
