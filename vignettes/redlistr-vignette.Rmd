...
type to identify ecosystems that are at risk from catastrophic disturbances. The
geographic distribution of an ecosystem type is assessed under criterion B with
two standardized metrics: the extent of occurrence (EOO) and the area of
occupancy (AOO) (Gaston and Fuller, 2009, Keith et al., 2013). It must be
emphasised that EOO and AOO are not used to estimate the mapped area of an
ecosystem like the methods we used in Criterion A; they are simply spatial
...
Refer to the guidelines for more information on AOO and EOO.
